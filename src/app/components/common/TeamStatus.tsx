...
const TeamStatus: React.FC<TeamStatusProps> = ({
  ...
  if (showReadyState && team.ready) {
    return (
      <div className="flex h-6 items-center gap-1 rounded-full border border-green-500 bg-green-500 bg-opacity-10 px-2 py-1 transition-all">
    ...
    return (
      <div className="flex h-6 items-center gap-1 rounded-full border border-gray-700 px-2 py-1 opacity-70 transition-all">
